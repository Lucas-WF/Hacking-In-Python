...
parser = argparse.ArgumentParser(prog="basic_portscan.py", description="Basic Python Portscan 1.0 (https://github.com/Lucas-WF/Hacking-In-Python)", usage="%(prog)s [target] {options}", epilog="Credits to Lucas Wagner Fernandes")
